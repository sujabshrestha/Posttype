                ...
                <div class="widget-content widget-content-area br-6">
                    <div class="row">
                        <div class="col-lg-12 col-12 mx-auto">
                            <form method="post" enctype="multipart/form-data" action="{{ route('posttypesubmit') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input id="post_type_title" value="" type="text" name="title" placeholder="Post Type Title..." class="form-control" required>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input  value="" id="t-text" type="text" name="icon" placeholder="Post Type Icon..." class="form-control" >
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input  value="" id="t-text" type="number" name="position" placeholder="Post Type Position..." class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
